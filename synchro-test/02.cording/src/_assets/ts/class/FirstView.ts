...
export class FirstView {
  ...
  private _show = () => {
    ...
    this._customElem.setAttribute(FvConst.PARAM_THEME, this._theme);
    try {
...
<div class="fvContainer" id="fvContainer">
  <p class="theme" id="${FvConst.PARAM_THEME}"></p>
  <p class="message">アンケートに答えてくれた優しい人との<br>回答一致率を表示するよ</p>
  <div class="okBtn" id="${FvConst.HTML_ID_BUTTON}">START</div>
</div>
`
