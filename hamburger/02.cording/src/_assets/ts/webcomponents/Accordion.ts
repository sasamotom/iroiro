...
export class Accordion {
  private _shadowRoot: ShadowRoot;        // コンポーネントのShadowRoot
  ...
  // ----------------------------------------------------
  // 機能： コンストラクタ
  // 引数： shadowRoot          ShadowRoot
  //      containerSelector   アコーディオンのボタンと内容を含む領域
  //      btnSelector         アコーディオンのボタン
  //      contentSelector     アコーディオンで表示非表示を切り替える領域
  // 返値： なし
  //----------------------------------------------------
  constructor(shadowRoot: ShadowRoot,containerSelector?: string, btnSelector?: string, contentSelector?: string) {
    ...
    // アコーディオンを全て取得
    const accordions = this._shadowRoot.querySelectorAll(this._containerSelector);
