...
gulp.task('clean:html', callback => {
  return del([dir.dist + '/**/*.html', '!' + dir.dist + '/pdfjs/**/*.*'], callback);
});
...
gulp.task('copypdfjs', () => {
  return gulp.src(['./pdfjs/**/*.*'], { base: 'pdfjs' })
    .pipe(gulp.dest(dir.dist + '/pdfjs'));
});
...
gulp.task('default', callback => {
  runSequence(['clean:images', 'clean:scripts', 'copy'], ['styles', 'scripts', 'imagemin', 'pug'], 'copypdfjs', 'browser-sync', 'watch', callback);
});

gulp.task('build', callback => {
  runSequence(['clean:images', 'clean:scripts', 'copy'], ['styles', 'scripts', 'imagemin', 'pug'], ['htmlmin', 'revision'], 'copypdfjs', callback);
});
